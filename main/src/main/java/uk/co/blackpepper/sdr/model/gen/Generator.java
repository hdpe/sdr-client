...
import uk.co.blackpepper.sdr.model.gen.AnnotationRegistry.AnnotationMappingCondition;
import uk.co.blackpepper.sdr.model.gen.annotation.EmbeddedResource;
import uk.co.blackpepper.sdr.model.gen.annotation.EmbeddedResources;
...
public class Generator {
	...
	static {
		...
		annotationRegistry.registerAnnotationMapping(
				uk.co.blackpepper.sdr.model.gen.annotation.RestRepository.class.getName(),
	...
	public void generate(ClassSource source, String targetPackageName, GeneratedClassWriter classWriter)
		...
		Annotation remoteResourceAnnotation = getAnnotation(source,
				uk.co.blackpepper.sdr.model.gen.annotation.RestRepository.class);
