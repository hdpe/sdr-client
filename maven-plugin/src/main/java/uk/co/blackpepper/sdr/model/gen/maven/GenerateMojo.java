...
import uk.co.blackpepper.sdr.model.gen.Generator;
import uk.co.blackpepper.sdr.model.gen.ReflectionClassSourceAdapter;
...
public class GenerateMojo extends AbstractMojo {
	...
	@Parameter(defaultValue = "${project.build.directory}/generated-sources/sdr-model", required = true)
